...
public class RecordMultiValueResolver{
    ...
    /*
     * public static List<Object> resolve(Record record, String key){ return resolve(record.prime, new RecordKey(key)); }
     *
     */
    ...
    /*
     * static List<Object> resolve(Record record, RecordKey key){ return resolve(record.prime, key); }
     *
     */
